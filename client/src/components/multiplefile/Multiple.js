...
export default function Multiple () {
    ...
    return(
        ...
        <h1>FFIDTRADE- SELL Your Account</h1>
                                ...
                                <div className="kb-data-box">
                                    <div className="kb-modal-data-title">
                                        <div className="kb-data-title">
                                            <h6>Upload your Account Images</h6>
                                        </div>
                                    </div>
                                    <form onSubmit={FileUploadSubmit}>
                                                    ...
                                                    return (
                                                        <div className="file-atc-box" key={id}>
                                                            ...
                                                            <div className="file-detail">
                                                                <h6>{filename}</h6>
                                                                <p></p>
                                                                <p><span>Size : {filesize}</span><span className="ml-2">Uploaded Time : {datetime}</span></p>
                                        ...
                                        <div className="kb-buttons-box">
                                            <button type="submit" className="btn btn-primary form-submit"><FileUploadIcon />Upload</button>
                                        </div>
                                    </form>
                                    {Files.length > 0 ?
                                                ...
                                                Files.map((data, index) => {
                                                    ...
                                                    return (
                                                        <div className="file-atc-box" key={index}>
                                                            ...
                                                            <div className="file-detail">
                                                                <h6>{filename}</h6>
                                                                <p><span>Size : {filesize}</span><span className="ml-3">Uploaded Time : {datetime}</span></p>
                                                                <div className="file-actions">
